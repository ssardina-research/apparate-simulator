...
public class MapLayer {
	 ...
	 * @param parent    the parent map grid
	 ...
	 * @param colour    the color to set for the coordinate
	 */
     ...
     *
	 * @param colours the colours to draw in the layer
	 */
	 ...
	 * @return true if valid for the layer
	 */
